...
# llm_disease_categorization documentation build
...
from llm_disease_categorization import __version__ as release

# -- Project information -----------------------------------------------------

project = "llm_disease_categorization"
author = "Kedro"
...
htmlhelp_basename = "llm_disease_categorizationdoc"
...
latex_documents = [
    (
        master_doc,
        "llm_disease_categorization.tex",
        "llm_disease_categorization Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "llm_disease_categorization",
        "Project llm_disease_categorization codebase.",
        "Data-Science",
    )
]
